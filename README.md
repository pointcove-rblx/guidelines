...
The following sections are under review and will be published as soon as review is approved:

 - Section A - Staff Guidelines (select sections)
 - Section B - Facilities (select sections)
 - Section C - Social Media (select sections)
 - Section E - Group Structure (role hierarchy as of early-2023 applies)
...
Rarely anyone is able to become a UM member of Pointcove. Developers are also considered UM staff as they share the same Team Create permissions with all other UM roles. The only possibilities for one to become a UM member is if:
 ...
 - majority of UM considered someone for a UM position
...
Pointcove welcomes everyone to access our facilities. However, we have strict rules for guests who come in to Pointcove establishments of any sort. Below are some guidelines for all members who enter any Pointcove establishment.
...
Our Discord Server, or our Communications Server, is a place where others can chat, recieve support on services and products, keep up to date with the group, and conduct many other activities while on the server. Upon joining, users will be screened to agree to the rules of the server. If users fail to comply, they will recieve moderation actions defined in C1B. We expect for **all** users to *show good conduct* to others in the server, and utilize common sense.
#### C1A - Server Rules
 1. You must not harrass, bully, or be borderline rude. *Be respectful*.
 2. The use of any sexual content, predatory behavior, and NSFW material is not allowed on any platform managed by Pointcove. Users **must** refrain from posting or sharing any sexual content, including pornographic material, CSAM material, and suggestive phrases that could be interpreted as sexual. These guidelines are further outlined in Section Z1 of the Pointcove ECH document.
 3. Racism against a minority, a specific group, or a specific person is prohibited.
 4. Do not spam messages, mass-ping, or excessively flood text channels
 5. **You are not** to conduct a scam operation. It is prohibited in any Pointcove-ran platform, including in this Discord server.
 6. Advertising or self-promotion outside of #promo is not allowed. This includes DM Advertising.
 7. **You are not** to start or organize a raid against the server.
 8. Impersonation or personal info leaking of any person in the server is not permitted.
 9. **Do not** encourage activities that are immoral and obscene
 10. **You are not** to intentionally start or extend drama in/to Pointcove grounds.
 ...
 > On top of all rules stated, users are to abide by all regulatory documents of Discord, including the community guidelines.
 
  > On top of all rules stated, users are to abide by the latest version of the Pointcove ECH Handbook.
...
Sexual Material
 - Intentially suggestive content showing or directing attention to human genitalia or any other private parts
 - Content that encourages **any** sexual act of **any** form
 - Phrases that are meant to be taxen in a sexual context
